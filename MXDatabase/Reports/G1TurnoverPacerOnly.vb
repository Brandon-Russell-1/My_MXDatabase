...
Public Class G1TurnoverPacerOnly
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "G1TurnoverPacerOnly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MXDatabase.G1TurnoverPacerOnly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedG1TurnoverPacerOnly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As G1TurnoverPacerOnly = New G1TurnoverPacerOnly
        rpt.Site = Me.Site
        Return rpt
    End Function
