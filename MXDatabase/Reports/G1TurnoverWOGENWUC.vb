...
Public Class G1TurnoverWOGENWUC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MXDatabase.G1TurnoverWOGENWUC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedG1TurnoverWOGENWUC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As G1TurnoverWOGENWUC = New G1TurnoverWOGENWUC
        rpt.Site = Me.Site
        Return rpt
    End Function
