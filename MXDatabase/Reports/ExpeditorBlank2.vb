...
Public Class ExpeditorBlank2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MXDatabase.ExpeditorBlank2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpeditorBlank2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExpeditorBlank2 = New ExpeditorBlank2
        rpt.Site = Me.Site
        Return rpt
    End Function
